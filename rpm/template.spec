Name:           ros-kinetic-gps-goal
Version:        0.1.0
Release:        0%{?dist}
Summary:        ROS gps_goal package

Group:          Development/Libraries
License:        Unlicense
URL:            http://wiki.ros.org/gps_goal
Source0:        %{name}-%{version}.tar.gz

Requires:       python-GeographicLib
Requires:       ros-kinetic-actionlib
Requires:       ros-kinetic-actionlib-msgs
Requires:       ros-kinetic-click
...
%changelog
* Sat Aug 19 2017 Daniel Snider <danielsnider12@gmail.com> - 0.1.0-0
